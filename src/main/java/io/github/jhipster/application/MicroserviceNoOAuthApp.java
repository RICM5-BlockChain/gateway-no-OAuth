...
public class MicroserviceNoOAuthApp {

    private static final Logger log = LoggerFactory.getLogger(MicroserviceNoOAuthApp.class);

    private final Environment env;

    public MicroserviceNoOAuthApp(Environment env) {
        this.env = env;
    }

    /**
     * Initializes MicroserviceNoOAuth.
     * <p>
    ...
    public static void main(String[] args) throws UnknownHostException {
        SpringApplication app = new SpringApplication(MicroserviceNoOAuthApp.class);
